Minecraft: Java Edition - Snapshot 22w11a
=========================================
...
*   Removed blending\_data.old\_noise, now existence of blending\_data in chunk data determines if a chunk is considered old
*   Added blending\_data.min\_section and blending\_data.max\_section that determines which sections will be used for data for blending
...
*   New registry types worldgen/world\_preset and worldgen/flat\_level\_generator\_preset were added to data-drive presents (like “Amplified” or “Single Biome”)
