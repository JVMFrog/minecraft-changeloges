Minecraft: Java Edition - Snapshot 22w15a
=========================================
...
*   Removed item\_delivered\_to\_player advancement trigger
*   Added thrown\_item\_picked\_up\_by\_player advancement trigger
*   Added avoid\_vibration advancement trigger
*   Added sonic\_explosion particle
...
#### THROWN\_ITEM\_PICKED\_UP\_BY\_PLAYER
...
*   Renamed game event tag ignore\_vibrations\_on\_occluding\_block to dampenable\_vibrations
*   Added block tag dampens\_vibrations to indicate blocks which will not trigger vibrations when placed, broken or stepped on
*   Renamed item tag occludes\_vibration\_signals to dampens\_vibrations item tag as well
